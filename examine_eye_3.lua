...
global function Use()
	...
	local doc_loc = FindNodeByName("console1_doc_loc")
	local amy_loc = FindNodeByName("console_amy_loc")
...
global function Hack()
	...
	local console = FindNodeByName("Console3Interact")
	local consoleH = FindNodeByName("Console3InteractHacked")
