...
global function Interact()
	...
	local locator = FindNodeByName("loc_ladder_teleport3_1")
...
global function MoveDone()
	ShowLetterBox()
	local cam_angle = FindNodeByName("Show_ladder1")
	cam_angle:Trigger()
	local doctor = GetActor("doctor")
	local amy = GetActor("amy")
	local down = FindNodeByName("int_ladder_teleport3")
	local up = FindNodeByName("int_ladder_teleport4")
	...
	local locator1 = FindNodeByName("loc_ladder_teleport3_2")
	local locator2 = FindNodeByName("loc_ladder_teleport3_3")
