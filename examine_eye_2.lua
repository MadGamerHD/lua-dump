...
global function Use()
	...
	local doc_loc = FindNodeByName("console6_doc_loc")
	local amy_loc = FindNodeByName("console6_amy_loc")
...
global function Hack()
	...
	local console = FindNodeByName("Console2Interact")
	local consoleH = FindNodeByName("Console2InteractHacked")
